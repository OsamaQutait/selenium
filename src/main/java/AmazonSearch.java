...
public class AmazonSearch {
    ...
    public String searchAmazonProduct(String department, String product) {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        String sponTextValue = driver.findElement(By.xpath("//*[@id=\"search\"]/div[1]/div[1]/div/span[3]/div[2]/div[1]/div/span/div/div/span")).getText();
        driver.quit();
        return sponTextValue;
    }
    public static void main(String[] args) throws InterruptedException {
        ...
        String sponTextValue = search_about_baby_shoes.searchAmazonProduct(department, product);
        System.out.println(sponTextValue);
